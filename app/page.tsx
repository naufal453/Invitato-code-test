  ...
  return (
    <div className="grid md:grid-cols-50 grid-cols-1 gap-0 h-screen">
      ...
      <div className="hidden md:block md:col-span-31 bg-cover bg-center border-r-10 border-black/30 relative" style={{ backgroundImage: 'url(https://invitato.net/test-product-engineer/static/3-8ac38da1cdc0fa503b46859811696a13.jpg)' }}>
        ...
        <p className='relative z-10 ms-10 my-10 text-white font-bold tracking-wider text-1xl'>WEDDING ANNOUNCEMENT</p>
        <p className='relative z-10 ms-10 my-10 text-white font-[family-name:var(--font-playfair)] text-7xl'>TIFFANY & <br />
JARED</p>
<p className='relative z-10 ms-10 my-10 text-white font-[family-name:var(--font-playfair)] text-1xl italic'>"Aku ingin mencintaimu dengan sederhana; dengan kata yang tak sempat diucapkan kayu kepada api yang menjadikannya abu. Aku ingin mencintaimu dengan sederhana; dengan isyarat yang tak sempat disampaikan awan kepada hujan yang menjadikannya tiada."
