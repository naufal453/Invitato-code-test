...
export default function Section2({ images, galleryIndex, isVisible, onBackClick, onNextImage, onPrevImage }: Section2Props) {
  return (
    <div className="min-h-screen relative flex flex-col justify-center items-center p-8">
      ...
      >
        <p className="text-center  text-3xl font-[family-name:var(--font-playfair)] mb-4">Welcome to <br />Tiffany & Jared’s <br />Wedding Website</p>
        <p className="text-center italic text-1xl font-[family-name:var(--font-playfair)] mb-4">Together with joyful hearts and the grace of God, we joyfully announce the upcoming of our marriage.</p>
        <br />
