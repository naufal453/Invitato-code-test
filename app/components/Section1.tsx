...
export default function Section1({ images, currentIndex, showFirstSection, onBackClick, onScrollClick }: Section1Props) {
  return (
    <div className="min-h-screen relative">
      ...
      <div
        className={`absolute top-[45%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center gap-8 transition-all duration-1000 ${
          showFirstSection ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-10'
        }`}
      >
        <p className="text-center text-3xl font-[family-name:var(--font-playfair)]">
