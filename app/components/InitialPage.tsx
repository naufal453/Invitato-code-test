  ...
  return (
    <div className="absolute inset-0">
      ...
      <div className="absolute top-[52%] left-1/2 -translate-x-1/2 -translate-y-1/2 z-20 flex flex-col items-center gap-2">
        ...
        <button
          onClick={onOpenClick}
          className="bg-white/100 hover:bg-white/50 text-black font-bold py-2 px-4"
        ><p className="text-center italic text-1xl font-[family-name:var(--font-playfair)]">Open</p>
        </button>
      </div>
    </div>
  );
